...
then
	...
	apt-get update
	apt-get install -y git mc ssh gawk grep sudo htop mysql-client php5-cli curl php5-cli
	apt-get autoclean
...
#echo 'Example: sudo TESTGROUPS="Bootstrap" DRUPALBRANCH="8.0.x" PATCH="/path/inthebox/to/your.patch,." ./run.sh'
